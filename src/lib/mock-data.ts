...
export const MOCK_ORDERS: Order[] = [
  ...
  },
  {
    ...
    notes: "Need extra stems for a large installation.",
    decline_reason: "Insufficient inventory for requested quantity",
    decline_note: "We only have 80 King Protea stems available this week. Check back next week — we expect a full harvest by Apr 21.",
    total_price: 900.0,
    ...
    items: MOCK_ORDER_ITEMS.filter((i) => i.order_id === "order-11"),
  },
  {
    id: "order-12",
    florist_id: "florist-1",
    ...
    notes: null,
    decline_reason: "Pickup date unavailable",
    decline_note: null,
    total_price: 200.0,
    ...
    items: MOCK_ORDER_ITEMS.filter((i) => i.order_id === "order-12"),
  },
  {
    id: "order-4",
    florist_id: "florist-2",
